package com.crickcet.apis.LiveCricketScoreBackend.entites;
...
public class Match {
    ...
    public Match(int matchId, String teamHeading, String matchNumberVenue,
                 ...
                 String bowlTeam, String bowlTeamScore,
                 String liveText, String matchLink,
                 String textComplete, MatchStatus status,
                 Date date) {
