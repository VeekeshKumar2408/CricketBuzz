package com.crickcet.apis.LiveCricketScoreBackend.services.impl;

import com.crickcet.apis.LiveCricketScoreBackend.entites.Match;
import com.crickcet.apis.LiveCricketScoreBackend.repositories.MatchRepository;
import com.crickcet.apis.LiveCricketScoreBackend.services.MatchService;
...
//              update the match in database
    ...
    private void updateMatchInDatabase(Match match1) {
                    //Searching for the match
       Match match = this.matchRepository.findByTeamHeading(match1.getTeamHeading()).orElse(null);

       //if match is equal to "null" then the new match1 will be saved in DB.
       if (match==null){
           matchRepository.save(match1);
       }else {
           /*here the updation in the match take place like if the match1 is found then other
